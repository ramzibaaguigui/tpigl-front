...
const Footer = () => {
    return (
        <footer class="p-4 bg-gray-900 sm:p-6 -mt-0.5">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center ">© 2023 <a href="#" class="hover:underline">merwan™</a>. All Rights Reserved.
                </span>
